...
<style>
  ...
  `}
        ...
        >
          <Link to={"/projects"}>
            <button className=" cursor-pointer w-full sm:w-48 transform rounded-lg bg-black px-6 py-3 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
              Explore My Projects
            </button>
          </Link>
          <Link to={"/contact"}>
            <button className=" cursor-pointer w-full sm:w-48 transform rounded-lg border border-gray-300 bg-white px-6 py-3 font-medium text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-100 dark:border-gray-700 dark:bg-black dark:text-white dark:hover:bg-gray-900">
              Connect with Me
            </button>
          </Link>
        </motion.div>
